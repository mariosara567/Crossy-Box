...
public class Grass : Terrain
{
    ...
    public void SetTreePercetage(float newProbability)
    {
        this.treeProbability = newProbability = Mathf.Clamp01(newProbability);
    }
    ...
    private void SpawnRandomTree(int xPos)
    {
        ...
        var tree = Instantiate(
            prefab,
            new Vector3(x: xPos, 0, this.transform.position.z),
            Quaternion.identity,
            transform);
    }
}